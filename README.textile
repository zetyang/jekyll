This is my fork of Jekyll, it just add the support for pandoc as the markdown
renderer of jekyll.

To install, make sure you have the `pandoc-ruby` gem in your computer. If not,
do like:
    gem install pandoc-ruby

Then build and install this jekyll:
...
Last thing to note is that you can't use pandoc in GithubPages, so you have to
generate all the site files locally and then push them to your github
pages repo.
